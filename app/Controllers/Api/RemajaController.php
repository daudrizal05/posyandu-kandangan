...
class RemajaController extends BaseController
{
    ...
    public function index()
    {
        ...
        if (in_array($role, ['kader', 'bidan']) && $posyandu_id) {
            ...
            $data = $this->model->getRemajaWithPosyandu();
        }
    ...
    {
        $rules = [
            'nik' => 'required|is_unique[remaja.nik]',
            'nama' => 'required',
        ];
        ...
        return $this->respondCreated(['message' => 'Data Remaja berhasil ditambahkan']);
    }
    ...
    public function update($id = null)
    {
        ...
        $rules = [
            'nik' => "required|is_unique[remaja.nik,id,{$id}]",
            'nama' => 'required',
        ];
        ...
        return $this->respond(['message' => 'Data Remaja berhasil diupdate']);
    }

    public function delete($id = null)
    {
        if ($this->model->delete($id)) {
            return $this->respondDeleted(['message' => 'Data Remaja berhasil dihapus']);
        }
        return $this->failNotFound('Data tidak ditemukan');
    }
}
