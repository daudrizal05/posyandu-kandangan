    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="<?= site_url('admin/balita/store') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="berat_lahir" name="berat_lahir" value="<?= old('berat_lahir') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tinggi_lahir">Tinggi Lahir (cm)</label>
                                    <input type="number" step="0.01" class="form-control" id="tinggi_lahir" name="tinggi_lahir" value="<?= old('tinggi_lahir') ?>">
                                </div>
                            </div>
                        </div>

                        <hr>
                        <h5 class="mb-3 text-info">Data Pengukuran / Gizi</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="berat">Berat Saat Ini (kg)</label>
                                    <input type="number" step="0.01" class="form-control" id="berat" name="berat" value="<?= old('berat') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tinggi">Tinggi Saat Ini (cm)</label>
                                    <input type="number" step="0.01" class="form-control" id="tinggi" name="tinggi" value="<?= old('tinggi') ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bb_u" name="bb_u" value="<?= old('bb_u') ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="zs_bb_u">ZS BB/U</label>
                                    <input type="number" step="0.01" class="form-control" id="zs_bb_u" name="zs_bb_u" value="<?= old('zs_bb_u') ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="tb_u">TB/U</label>
                                    <input type="text" class="form-control" id="tb_u" name="tb_u" value="<?= old('tb_u') ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="zs_tb_u">ZS TB/U</label>
                                    <input type="number" step="0.01" class="form-control" id="zs_tb_u" name="zs_tb_u" value="<?= old('zs_tb_u') ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bb_tb" name="bb_tb" value="<?= old('bb_tb') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="zs_bb_tb">ZS BB/TB</label>
                                    <input type="number" step="0.01" class="form-control" id="zs_bb_tb" name="zs_bb_tb" value="<?= old('zs_bb_tb') ?>">
                                </div>
                            </div>
                        </div>
                        <hr>
