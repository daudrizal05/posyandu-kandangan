    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="<?= site_url('admin/posyandu/store') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="desa_kelurahan" name="desa_kelurahan" value="<?= old('desa_kelurahan') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_ketua_kader" name="nama_ketua_kader" value="<?= old('nama_ketua_kader') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
